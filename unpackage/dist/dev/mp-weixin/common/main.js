...
_vue.default.prototype.$http = function (url, data) {var type = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 'GET';
  console.log('type', type);
  var tmp_token = this.$store.state.token;
  return new Promise(function (resolve, reject) {
    wx.request({
      url: _api.default + url,
      data: data,
      method: type,
      header: {
